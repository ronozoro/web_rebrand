...
openerp.enterprise_backend_v8 = function (instance) {
        ...
        bind_hashchange: function () {
            ...
            if (_.isEmpty(state) || state.action == "login") {
                self.menu.is_bound.done(function () {
                    new instance.web.Model("res.users").call("read", [instance.session.uid, ["action_id"]]).done(function (data) {
                        if (data.action_id) {
    ...
    instance.web.Menu.include({
        bind_menu: function () {
            ...
            this.$el.on('click', 'a[data-menu]', function (event) {
                ...
                instance.web.bus.trigger('change_menu_section', menu_id, needaction);
            });
